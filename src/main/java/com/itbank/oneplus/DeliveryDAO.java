...
public interface DeliveryDAO {
	...
	@Insert("insert into delivery (dCode, receiverName, receiverPhonenum, member_idx, addr1, addr2, addr3, dInfo1) "
			+ "values (delivery_seq.nextval, #{receiverName}, #{receiverPhonenum}, #{member_idx}, #{addr1}, #{addr2}, #{addr3}, #{dInfo1})")
