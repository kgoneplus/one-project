            ...
            <div class="userBaseInfo">
                ...
                <div class="userBaseInfo_coupon">
                    <ul>
                        <li>
                            <em>쿠폰</em>
                            <div class="couponCnt"><a href="${cpath}/mypage/coupon">0</a> 장</div>
                        </li>
                        <li>
                            <em>마일리지</em>
                            <div class="couponCnt"><a href="${cpath}/mypage/point">0</a> p</div>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="userTimelineBox">
                ...
                <div class="orderSummaryBox">
                    <ul>
                        <li>
                            <em>결제완료</em>
                            <div class="orderStatus"><a href="${cpath}/mypage/orders">0</a></div>
                        </li>
                        <li>
                            <em>상품준비중</em>
                            <div class="orderStatus blue"><a href="${cpath}/mypage/orders">0</a></div>
                        </li>
                        <li>
                            <em>배송중</em>
                            <div class="orderStatus red"><a href="${cpath}/mypage/orders">0</a></div>
                        </li>
                        <li>
                            <em>배송완료</em>
                            <div class="orderStatus"><a href="${cpath}/mypage/orders">0</a></div>
                        ...
                        <li>
                            <em>취소/반품/교환</em>
                            <div class="orderStatus grey"><a href="${cpath}/mypage/claim">0</a></div>
                        </li>
                    </ul>
                </div>
            </div>
