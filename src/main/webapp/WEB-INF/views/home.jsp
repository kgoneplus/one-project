    ...
    <main>
        <div class="slider">
            <div class="mainImg_wrap">
                <div class="mainImg" style="background-image: url(${cpath}/resources/img/mainImg.jpeg);"></div>
                <div class="mainImg" style="background-image: url(${cpath}/resources/img/mainImg2.png);"></div>
                <div class="mainImg" style="background-image: url(${cpath}/resources/img/mainImg3.png);"></div>
                <div class="mainImg" style="background-image: url(${cpath}/resources/img/mainImg4.jpeg);"></div>
                <div class="mainImg" style="background-image: url(${cpath}/resources/img/mainImg5.png);"></div>
            </div>
            <div class="slider_menu">
                <div><img src="${cpath }/resources/img/imgLeft.png" class="prev"></div>
        ...
        <div class="list">
            <div class="product">
                ...
                <div class="productInfo">
                    <div class="productTitle">
                        항공 직속 체리(미국산) 300G(팩) zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz
                    </div>
                    <div class="priceWrap">
                        ...
                        <div class="productPrice">
                            <span class="countDC">38%</span>
                            <strong>7,990</strong>원
                        </div>
                        <span class="priceQty">(100G당 2,663.3원)</span>
                    </div>
                    <div class="productScore">
                        <span><img src="${cpath }/resources/img/star3.png"></span>
                        <span>4.3(9건)</span> |
            ...
            <div class="product">
                ...
                <div class="productInfo">
                    ...
                    <div class="priceWrap">
                        ...
                        <div class="productPrice">
                            <span class="countDC">30%</span>
                            <strong>8,990</strong>원
                        </div>
                        <span class="priceQty">(1개 당 8,990원)</span>
                    </div>
                    <div class="productScore">
                        <span><img src="${cpath }/resources/img/star3.png"></span>
                        <span>4.7(17,242건)</span> |
            ...
            <div class="product">
                <div class="productImg"><img src="${cpath }/resources/img/호주청정우.jpeg"></div>
                <div class="productInfo">
                    <div class="productTitle">
                        [호주청정우]곡물먹고 자란 척아이롤 100G/소고기
                    </div>
                    <div class="priceWrap">
                        <div class="productOrgPrice">
            ...
            <div class="product">
                <div class="productImg"><img src="${cpath }/resources/img/맥심미니언즈.jpeg"></div>
                <div class="productInfo">
                    <div class="productTitle">
                        동서 맥심 모카골드믹스 미니언즈 기획팩200T (2400G) ㅎㅎㅎㅎㅎ
                    </div>
                    <div class="priceWrap">
                        <div class="productOrgPrice">
                            <strong></strong>
